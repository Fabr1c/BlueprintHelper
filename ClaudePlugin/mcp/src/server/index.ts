/**
 * BlueprintHelper MCP Server �?鍏ュ�?
 *
 * stdio 妯″紡杩愯锛岄€氳繃 TCP 杩炴�?UE5 Bridge (127.0.0.1:54321)�?
 * 杈撳嚭鏃ュ織�?console.error锛坰tdout 淇濈暀�?JSON-RPC锛夈�?
 */
...
// 灞曞紑甯歌鐨勬ā鏉垮彉閲忥紙�?${workspaceFolder}锛夛紝纭繚璺緞鍙敤
// 鈹€鈹€鈹€ 鍚�?鈹€鈹€鈹€

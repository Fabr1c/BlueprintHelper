...
|---|---|
| Unreal plugin `BlueprintHelper.uplugin` | `VersionName` 0.5.8 |
| CLI `AgentFaceService/cli/package.json` | 0.5.8 |
| Shared task core `AgentFaceService/task-core/package.json` | 0.5.8 |
| Global MCP allowlist package `AgentFaceService/mcp/package.json` | 0.5.8 |

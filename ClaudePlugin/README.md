...
|---|---|
| Unreal plugin `BlueprintHelper.uplugin` | `VersionName` 0.6.6 |
| CLI `AgentFaceService/cli/package.json` | 0.6.6 |
| Shared task core `AgentFaceService/task-core/package.json` | 0.6.6 |
| Global MCP allowlist package `AgentFaceService/mcp/package.json` | 0.6.6 |

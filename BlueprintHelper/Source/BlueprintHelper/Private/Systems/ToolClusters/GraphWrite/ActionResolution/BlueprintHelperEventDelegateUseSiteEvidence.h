...
struct FBlueprintHelperEventDelegateUseSiteEvidence
{
	...
	FString BindingObjectKind;
	FString BindingObjectEvidenceId;
	FString BindingObjectPath;
	FString BindingObjectProducerStatementId;
	FString BindingObjectNodeGuid;
	FString BindingObjectPinName;
	FString BindingObjectError;
	FString HandlerName;

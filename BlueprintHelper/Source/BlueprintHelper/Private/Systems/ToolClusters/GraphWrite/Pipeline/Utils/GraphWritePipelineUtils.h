...
public:
	...
	static FBlueprintHelperGraphSemanticPinBindings CollectSemanticPinBindings(const FBlueprintHelperGraphFragmentDag& FragmentDag, const TArray<FBlueprintHelperNodeFragment>& GeneratedFragments, const FString& ConsumerFragmentId);
	static bool SpawnSemanticStatementFragment(UEdGraph* TargetGraph, const FBlueprintHelperActionContextScope* ActionContextScope, const TSharedPtr<FBlueprintHelperGraphStatementIR>& Statement, FBlueprintHelperNodeFragment& OutFragment, FString& OutError, TArray<FBlueprintHelperCandidateFunctionGroup>* OutCandidateFunctions = nullptr, const FBlueprintHelperGraphSemanticPinBindings* SemanticPinBindings = nullptr);

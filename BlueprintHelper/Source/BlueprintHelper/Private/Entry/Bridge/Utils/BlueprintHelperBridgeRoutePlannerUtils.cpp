...
static const TPair<const TCHAR*, EBlueprintHelperBridgeRouteCluster> GBlueprintHelperBridgeRouteCommandClusters[] = {
	...
	{TEXT("rollback_cleanup_transaction"), EBlueprintHelperBridgeRouteCluster::CleanupOwnership},
	{TEXT("convert_blueprint_helper_block_to_user_owned"), EBlueprintHelperBridgeRouteCluster::CleanupOwnership},
...
static const TPair<EBlueprintHelperBridgeRouteCluster, const TCHAR*> GBlueprintHelperBridgeRouteClusterNames[] = {
	...
	{EBlueprintHelperBridgeRouteCluster::CleanupOwnership, TEXT("CleanupOwnership")},

...
static const FBlueprintHelperGeneratedReadContextRouteDescriptor GBlueprintHelperReadContextRoutes[] = {
	...
	{TEXT("read.blueprint.logic.blueprint.logic_md"), TEXT("read_blueprint_logic_md"), TEXT("SharedServices"), TEXT("blueprint"), TEXT("logic"), TEXT("blueprint"), TEXT("logic_md"), TEXT("active")},
	...
	{TEXT("read.blueprint.logic.custom_event.logic_md"), TEXT("read_blueprint_logic_md"), TEXT("SharedServices"), TEXT("blueprint"), TEXT("logic"), TEXT("custom_event"), TEXT("logic_md"), TEXT("active")},
	...
	{TEXT("read.blueprint.logic.event.logic_md"), TEXT("read_blueprint_logic_md"), TEXT("SharedServices"), TEXT("blueprint"), TEXT("logic"), TEXT("event"), TEXT("logic_md"), TEXT("active")},
	...
	{TEXT("read.blueprint.logic.function.logic_md"), TEXT("read_blueprint_logic_md"), TEXT("SharedServices"), TEXT("blueprint"), TEXT("logic"), TEXT("function"), TEXT("logic_md"), TEXT("active")},
	...
	{TEXT("read.blueprint.logic.graph.logic_md"), TEXT("read_blueprint_logic_md"), TEXT("SharedServices"), TEXT("blueprint"), TEXT("logic"), TEXT("graph"), TEXT("logic_md"), TEXT("active")},

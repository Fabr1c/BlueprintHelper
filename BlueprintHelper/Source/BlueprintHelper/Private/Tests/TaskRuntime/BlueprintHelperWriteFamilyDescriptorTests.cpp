...
bool FBlueprintHelperWriteFamilyDescriptorMatrixTest::RunTest(const FString&)
{
	...
	const TArray<FExpectedWriteFamilyDescriptor> RequiredFamilies = {
		{TEXT("graphwrite"), TEXT("graphwrite_route_descriptor"), TEXT("graph_body_adapter"), TEXT("blueprint.write.graphwrite")},
		{TEXT("asset_factory"), TEXT("asset_factory"), TEXT("asset_factory"), TEXT("blueprint.write.asset_factory")},
		{TEXT("blueprint_signature"), TEXT("blueprint_signature"), TEXT("blueprint_signature"), TEXT("blueprint.write.signature")},
		{TEXT("blueprint_variables"), TEXT("blueprint_variables"), TEXT("blueprint_variables"), TEXT("blueprint.write.variables")},
		{TEXT("class_settings"), TEXT("class_settings"), TEXT("class_settings"), TEXT("blueprint.write.class_settings")},
		{TEXT("blueprint_component"), TEXT("blueprint_component"), TEXT("blueprint_component"), TEXT("blueprint.write.component")},
		{TEXT("object_property"), TEXT("property_strategy"), TEXT("object_property"), TEXT("blueprint.write.object_property")},
		{TEXT("data_table"), TEXT("row_strategy"), TEXT("data_table"), TEXT("blueprint.write.data_table")},
		{TEXT("umg_widget"), TEXT("widget_strategy"), TEXT("widget_tree"), TEXT("umg.write.umg_widget")}
	};

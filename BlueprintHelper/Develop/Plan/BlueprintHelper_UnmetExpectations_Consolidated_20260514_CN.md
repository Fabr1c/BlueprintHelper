...
| P0 | v0.5.0 TaskSpec/read performance work | In Progress | `BlueprintHelper_v0.5.0_TaskSpecExecution_PerformanceOptimization_20260519_CN.md` | Finish P0-0/R0 timing evidence, then decide and implement P0-1/P0-2/P0-3 in order. |
...
- v0.5.0 performance plan: `BlueprintHelper_v0.5.0_TaskSpecExecution_PerformanceOptimization_20260519_CN.md`
...
4. v0.5.0 optimization must preserve the GameThread boundary for UE object access. Background work may only process detached DTOs.

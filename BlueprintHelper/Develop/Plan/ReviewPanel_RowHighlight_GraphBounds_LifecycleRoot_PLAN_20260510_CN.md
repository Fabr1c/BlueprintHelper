...
- [x] **Step 1: Add visible change lifecycle fields**
...
- [x] **Step 3: Mark asset factory creation as root**
...
- [x] **Step 4: Link children on pending load**
...
- [x] **Step 2: Implement root reject semantics**
...
- [x] **Step 3: Render lifecycle tree**
...
- [x] **Step 1: Add shared row highlight state**
...
- [x] **Step 2: Add shared color helper**
...
- [x] **Step 3: Remove row overlay usage**
...
- [x] **Step 5: Add row behavior tests**
...
- [x] **Step 1: Add structured graph review node anchor**
...
- [x] **Step 2: Record anchors from ReplaceBlueprintGraph**
...
- [x] **Step 3: Convert anchors into review targets**
...
- [x] **Step 4: Add aggregate graph bounds**

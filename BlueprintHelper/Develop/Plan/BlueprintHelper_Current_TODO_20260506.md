...
- [ ] Function/Event Signature remaining: real remove execution after reference-analysis cleanup policy and dispatcher signature migration strategy beyond block.

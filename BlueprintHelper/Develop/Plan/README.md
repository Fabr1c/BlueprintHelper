...
This folder contains only active or living planning documents. Completed v0.4.4-era records are archived under `../v0.4.4/ArchivedReference/CompletedDevelopDocs_20260519/`; older setup, smoke, AgentGuide, Review/Debug v1, and legacy records remain under their original version archive folders.
...
- `Optimization/BlueprintHelper_v0.5.0_TaskSpecExecution_PerformanceOptimization_20260519_CN/README.md`
- `Optimization/BlueprintHelper_v0.5.0_TaskSpecExecution_PerformanceOptimization_20260519_CN/P0_TaskSpecExecuteFastPath_ImplementationPlan_CN.md`
- `Optimization/BlueprintHelper_v0.5.0_TaskSpecExecution_PerformanceOptimization_20260519_CN/P1_TaskSpecCompilerFastPath_ImplementationPlan_CN.md`
...
- `../v0.4.4/ArchivedReference/CompletedDevelopDocs_20260519/`
- `../v0.4.3/ArchivedReference/RetiredReviewDebugDocs_20260518/`

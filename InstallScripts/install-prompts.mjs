...
function createInstallOptions(input) {
  return [
    ...
    makeOption('codexSupport', '安装 Codex Desktop 支持', bool(input.codexSupport, true), '启用 Codex 集成。子项控制官方插件入口、subagents 和 lifecycle MCP 配置。'),
    makeOption('codexMarketplace', '通过官方入口安装 Codex 插件', bool(input.codexMarketplace, true), '注册本地 marketplace，并通过 Codex 官方插件入口安装 blueprint-helper。', 1, 'codexSupport'),

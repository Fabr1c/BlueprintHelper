...
class GraphWriteAppendCompilerTests(unittest.TestCase):
    def test_rejects_graph_write_user_node_mutation_until_non_owned_anchor_contract_exists(self):
        spec = make_task_spec(scope_policy={
        ...
        self.assertEqual(ctx.exception.code, "unsupported_scope_policy")
        self.assertEqual(ctx.exception.issues[0]["path"], "scope_policy.allow_modify_user_nodes")
        self.assertEqual(ctx.exception.issues[0]["suggested_patch"], {
            "op": "replace",

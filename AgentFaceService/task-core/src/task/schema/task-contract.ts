...
export const TASK_PROTOCOL_CONTRACT_V1 = {
  ...
  task_plan_required_paths_by_capability: {
    graph_write: ['steps[].target.asset_path', 'steps[].target.graph'],
    blueprint_signature: ['steps[].target.asset_path', 'steps[].write.strategy', 'steps[].write.ops[]'],
  },
  ...
  graph_write_taskspec_contract: {
    ...
    patch_owned_graph: {
      kinds: ['set_pin_default', 'set_node_comment', 'connect_pins', 'disconnect_link', 'replace_link', 'delete_owned_node'],
      scope_derivation: {
      ...
      field_shapes: {
        ...
        connect_pins: ['target_ref.block_id', 'target_ref.group_entry_node_path', 'target_ref.node_ref', 'target_ref.pin_ref', 'source_ref.node_ref', 'source_ref.pin_ref'],
        disconnect_link: ['target_ref.block_id', 'target_ref.group_entry_node_path', 'target_ref.node_ref', 'target_ref.pin_ref', 'target_ref.link_ref'],
        replace_link: ['target_ref.block_id', 'target_ref.group_entry_node_path', 'target_ref.node_ref', 'target_ref.pin_ref', 'target_ref.link_ref', 'replacement_ref.node_ref', 'replacement_ref.pin_ref'],
        delete_owned_node: ['target_ref.block_id', 'target_ref.group_entry_node_path', 'target_ref.node_ref', 'delete_policy.break_links', 'delete_policy.allow_entry_node', 'delete_policy.allow_lifecycle_root'],
      },
  ...
  signature_taskspec_contract: {
    task_type: 'edit_blueprint_signature',
    target_type: 'blueprint',
    signature_strategy: 'signature_edit',
    pin_spec: 'SignaturePinSpec',
    pin_type_spec: 'BlueprintPinTypeSpec',
    legacy_pin_type_tokens: 'rejected',
    existing_function_mismatch: 'blocks preview and execute with function_signature_mismatch',
    change_kinds: [
      'ensure_function',
    ...
    agent_semantic_paths: [
      ...
      'behavior.changes[].kind',
      'behavior.changes[].inputs[].pin_type',
      'behavior.changes[].outputs[].pin_type',
    ],
    forbidden_agent_fields: [
      'steps[].operation',
      'write.ops[].op',
      'adapter_operation',
      'legacy string pin_type tokens',
    ],
    task_plan_capability: 'blueprint_signature',
    runtime_supported_structural_ops: [
      'ensure_function',
      'ensure_custom_event',
      'ensure_event_dispatcher',
  ...
  supported_p1_slices: [
    ...
    },
    {
      ...
      agent_semantic_paths: [
        ...
        'behavior.changes[].class',
        'behavior.changes[].parent',
        'behavior.changes[].socket',
        'behavior.changes[].attach_rule',
        'behavior.changes[].properties[]',
        'behavior.changes[].name_collision_policy',
        'behavior.changes[].new_name',
        'behavior.changes[].new_parent',
        'behavior.changes[].transform_policy',
        'behavior.changes[].default_root_policy',
        'behavior.changes[].old_root_policy',
        'behavior.changes[].delete_policy',
      ],
      forbidden_agent_fields: [
        'behavior.changes[].op',
        'behavior.changes[].attach_to',
        'behavior.changes[].class_spec',
        'behavior.changes[].component_id',
        'behavior.changes[].component_template_path',
        'behavior.changes[].component_origin',
        'behavior.changes[].readback_fingerprint_before',
        'behavior.changes[].readback_fingerprint_after',
        'steps[].operation',
        'write.ops[].op',
      ],
    ...
    },
    {
      ...
      existing_function_mismatch: 'function_signature_mismatch blocks preview and execute',
    },
    {
  ...
  capability_catalog: {
    ...
    task_runtime_clusters: [
      ...
      },
      {
        ...
        note: 'Agents express Signature lifecycle through edit_blueprint_signature TaskSpec. TaskPlan blueprint_signature steps remain compiler-owned IR.',
      },
      {

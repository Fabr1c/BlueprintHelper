...
export const NON_GRAPHWRITE_OPERATION_DESCRIPTORS: readonly NonGraphWriteOperationDescriptor[] = [
  ...
  op('blueprint_class_settings', 'class_settings', 'set_class_default', 'Set a Blueprint class default property, including native component default properties such as WeaponComponent.PrimaryWeapon.', 'blueprint_class_settings_class_default', ['behavior.class_defaults[]'], ['property_path(*)', 'value(*)']),
  {
    ...
    cluster_id: 'class_settings',
    operation_id: 'set_class_default_via_setter',
    template_id: 'blueprint_class_settings.class_settings.set_class_default_via_setter',
    template_path: 'AgentFaceService/agent-guide/Templates/write/routes/blueprint_class_settings_class_default_setter_template.json',
    source_slot_id: 'blueprint_class_settings_class_default_setter',
    insert_paths: ['behavior.class_defaults'],
    arg_slots: ['property_path(*)', 'value(*)', 'mutation_strategy(*)'],
    description: 'Set a Blueprint class default property through a reflected setter/getter pair when direct property write is blocked.',
  ...
  op('blueprint_signature', 'signature', 'remove_signature', 'Remove a signature with reference-context protection.', 'blueprint_signature_remove', ['behavior.changes[]'], ['signature_kind(*)', 'signature_name(*)']),
  baseOp(

...
const READ_CONTEXT_ROUTE_CLUSTER_BY_BRIDGE_COMMAND: Readonly<Record<string, string>> = {
  ...
  read_blueprint_class_default_property: 'ClassSettings',
...
const READ_CONTEXT_ROUTE_DESCRIPTORS: readonly ReadContextRouteDescriptor[] = [
  ...
  active('blueprint.class_defaults.property', 'blueprint', 'properties', 'Read Blueprint GeneratedClass CDO default property, including nested paths.', {
    ...
    supported_asset_types: ['blueprint', 'property'],
    supported_formats: ['property_json'],
    format: 'property_json',
    context_evidence: {

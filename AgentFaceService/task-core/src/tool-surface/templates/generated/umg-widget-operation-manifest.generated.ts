...
export const UMG_WIDGET_OPERATION_MANIFEST_GENERATED_FROM = 'src/tool-surface/templates/umg-widget-operation-descriptors.ts';

export const UMG_WIDGET_OPERATION_MANIFEST = [
  {
    "kind": "create_widget",
  ...
  },
  {
    ...
    "optional_fields": [
      "replacement_widget_class",
      "replacement_widget_name",
      "expected_root_class_path",
      "dry_run"
    ],
    "string_enum_fields": {
      "replacement_policy": [

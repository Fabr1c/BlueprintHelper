...
const helpEntries: Record<string, HelpEntry> = {
  ...
  blueprinthelper_read_context: {
    ...
    templates: [
      `${TEMPLATE_ROOT}/read/routes/blueprint_logic_function_logic_flow_template.json`,
      `${TEMPLATE_ROOT}/read/routes/blueprint_logic_graph_logic_json_template.json`,
      `${TEMPLATE_ROOT}/read/routes/blueprint_components_template.json`,
      `${TEMPLATE_ROOT}/read/routes/blueprint_variables_template.json`,
    ],
    notes: [
  ...
  blueprinthelper_preview_task: {
    ...
    templates: [
      ...
      `${TEMPLATE_ROOT}/write/routes/blueprint_create_feature_template.json`,
      `${TEMPLATE_ROOT}/write/routes/graph_append_container_action_template.json`,
      `${TEMPLATE_ROOT}/write/routes/graph_append_event_delegate_template.json`,
      `${TEMPLATE_ROOT}/write/routes/graph_append_generic_schedule_template.json`,
      `${TEMPLATE_ROOT}/write/routes/graph_append_generic_ops_template.json`,
    ],

...
`blueprinthelper_execute_task`, use wrapper templates with the `task_spec` root
field.

Common write loop:

1. Read context with a returned read template.
2. Copy a returned TaskSpec template.

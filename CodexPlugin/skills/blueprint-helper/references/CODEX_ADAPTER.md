...
- Prefer CLI for ordinary TaskSpec/ReadSpec/debug-summary work. Use global MCP only for editor open/close and developer-only exec command. Deprecated MCP ordinary tools are not fallback paths and must not be tested.

...
EBlueprintHelperBridgeStatus FBlueprintHelperRuntimeProfileService::DetectBridgeStatus()
{
	...
	// 实际更精确的判断需要 BridgeServer 暴露 IsRunning() 接口

// BlueprintHelper Service Layer — MergeGraphTypes ToJson 实现

#include "Services/BlueprintHelperMergeGraphTypes.h"
#include "Services/BlueprintHelperAppendGraphTypes.h"

TSharedRef<FJsonObject> FBlueprintHelperMergeDryRunResult::ToJson() const
{
...
TSharedRef<FJsonObject> FBlueprintHelperMergeDryRunData::ToJson() const
{
	TSharedRef<FJsonObject> Json = MakeShared<FJsonObject>();

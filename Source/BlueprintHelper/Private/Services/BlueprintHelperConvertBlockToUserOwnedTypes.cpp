// BlueprintHelper Service Layer — ConvertBlockToUserOwnedTypes ToJson

#include "Services/BlueprintHelperConvertBlockToUserOwnedTypes.h"

TSharedRef<FJsonObject> FBlueprintHelperConvertBlockToUserOwnedDryRunResult::ToJson() const
{
...
TSharedRef<FJsonObject> FBlueprintHelperConvertBlockToUserOwnedDryRunData::ToJson() const
{
	TSharedRef<FJsonObject> J = MakeShared<FJsonObject>();
